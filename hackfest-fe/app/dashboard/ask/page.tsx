...
//                             <>
//                                 <span className="lg:hidden"><Menu size={20} /></span>
//                                 <span className="hidden lg:block"><PanelLeftOpen size={20} /></span>
//                             </>
//                         )}
//                     </button>
...
//                                     <div
//                                         className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center font-bold text-white ${msg.sender === "ai"
//                                             ? msg.type === "github"
...
//                                     >
//                                         {msg.sender === "ai" ? (
//                                             msg.type === "github" ? <Github size={20} /> : <Bot size={24} />
//                                         ) : (
//                                             <User size={24} />
//                                         )}
//                                     </div>
...
//                                                 <span className={`px-2 py-1 text-xs rounded-full ${msg.type === "github"
//                                                     ? "bg-purple-500/20 text-purple-300"
//                                                     : msg.type === "integration"
//                                                         ? "bg-green-500/20 text-green-300"
//                                                         : "bg-blue-500/20 text-blue-300"
//                                                     }`}>
//                                                     {msg.type === "github" ? "GitHub API" :
//                                                         msg.type === "integration" ? "Integrations" : "General AI"}
//                                                 </span>
//                                             )}
//                                         </div>
...
//                     {/* ===== Input Form ===== */}
//                     <div className="mt-auto p-4 sm:p-6 bg-gray-900/50 backdrop-blur-sm border-t border-gray-700/50">
//                         <div className="max-w-4xl mx-auto">
//                             {/* Quick Action Buttons */}
//                             <div className="flex items-center gap-2 mb-3 overflow-x-auto pb-2">
//                                 {/* DUMMY GITHUB BUTTON ADDED HERE */}
//                                 <button
//                                     onClick={() => setCurrentMode(currentMode === 'github' ? 'auto' : 'github')}
...
//                                      <button
//                                          key={key}
//                                          onClick={() => handleIntegrationToggle(key as "slack" | "notion" | "gmail" | "teams" | "drive")}
//                                          className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-colors border ${
//                                              activeIntegrations[key as keyof typeof activeIntegrations]
...
//                                             : "Ask SEAM anything..."
//                                     }
//                                     className="w-full bg-gray-800 border border-gray-600 rounded-lg p-4 pr-16 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 transition-shadow text-base"
//                                     rows={1}
//                                     disabled={isLoading}
//                                 />
//                                 <button
                    ...
                    <div className="mt-auto p-4 sm:p-5 bg-gray-900/50 backdrop-blur-sm border-t border-gray-700/50">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="flex items-center gap-2 mb-3 overflow-x-auto pb-2">
                                ...
                                <button
                                    onClick={() => setCurrentMode(currentMode === 'github' ? 'auto' : 'github')}
                                    className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-colors border ${currentMode === 'github'
                                            ? 'bg-purple-500/20 text-purple-300 border-purple-500'
                                            : 'bg-gray-700 text-gray-300 border-transparent hover:bg-gray-600'
                                        }`}
                                >
                                ...
                                {Object.keys(activeIntegrations).map((key) => (
                                    <button
                                        key={key}
                                        onClick={() => handleIntegrationToggle(key as "slack" | "notion" | "gmail" | "teams" | "drive")}
                                        className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-colors border ${activeIntegrations[key as keyof typeof activeIntegrations]
                                                ? 'bg-green-500/20 text-green-300 border-green-500'
                                                : 'bg-gray-700 text-gray-300 border-transparent hover:bg-gray-600'
                                            }`}
                                    >
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-colors border ${isSimplifyEnabled
