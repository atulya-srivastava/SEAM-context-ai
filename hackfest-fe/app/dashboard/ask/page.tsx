...
• **Slack, Notion, Gmail & Teams Integration** - Connect with your tools
...
How can I help you today?`,
    ...
    const handleIntegrationToggle = (
        integrationId: "slack" | "notion" | "gmail" | "teams"
    ) => {
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="flex items-center gap-2 mb-3 overflow-x-auto pb-2">
                                ...
                                {Object.keys(activeIntegrations).map((key) => (
                                     <button
                                         key={key}
                                         onClick={() => handleIntegrationToggle(key as "slack" | "notion" | "gmail" | "teams")}
                                         className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-colors border ${
